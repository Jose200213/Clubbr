...
public class stablishmentService {
    ...
    public void init(){
        stablishment Comedia = new stablishment();
        Comedia.setStabName("Comedia");
        Comedia.setStabAddress("Calle de la Comedia, 14, 11403 Jerez");
        Comedia.setOpenTime(LocalTime.parse("22:00"));
        Comedia.setCloseTime(LocalTime.parse("06:00"));
        Comedia.setCapacity(200);
        addStablishment(Comedia);
    }
